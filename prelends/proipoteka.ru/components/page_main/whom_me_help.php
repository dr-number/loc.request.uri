...
<div class="whom-we-help grve-section grve-row-section grve-fullwidth-background grve-padding-top-1x grve-padding-bottom-2x grve-bg-none grve-headings-dark grve-custom-height grve-equal-column grve-tablet-sm-row-hide grve-mobile-row-hide"
...
<div class="whom-we-help grve-section grve-row-section grve-fullwidth-background grve-padding-top-1x grve-padding-bottom-2x grve-bg-none grve-headings-dark grve-custom-height grve-equal-column grve-desktop-row-hide grve-tablet-row-hide grve-mobile-row-hide"
    style="background-color: #2b2b2b; color: #000000;">
    <div class="grve-container">
...
<div class="whom-we-help grve-section grve-row-section grve-fullwidth-background grve-padding-top-1x grve-padding-bottom-3x grve-bg-none grve-headings-dark grve-custom-height grve-equal-column grve-desktop-row-hide grve-tablet-row-hide grve-tablet-sm-row-hide"
    style="background-color: #2b2b2b; color: #000000;">
    <div class="grve-container">
        <div class="grve-row grve-bookmark grve-columns-gap-60">
            <div class="grve-column wpb_column grve-column-1-4 grve-tablet-sm-column-1 grve-clipping-animation grve-clipping-up" style="color: #000000;" data-delay="600">
